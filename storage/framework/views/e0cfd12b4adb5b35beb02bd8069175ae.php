        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    ...
                    onclick="openEditModal(<?php echo e($item['id_nilai']); ?>)">
                    <i class="bi bi-pencil-square"></i> Edit
                </button>
                
                
                <form action="<?php echo e(route('dosen.nilai-mahasiswa.destroy', $item['id_nilai'])); ?>" method="POST" style="display:inline;">
                    <?php echo csrf_field(); ?>
...
<div class="modal fade" id="inputNilaiModal" tabindex="-1" aria-labelledby="inputNilaiModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <form action="<?php echo e(route('dosen.nilai-mahasiswa.store')); ?>" method="POST">
                <?php echo csrf_field(); ?>
...
<script>
    const idDosen = "<?php echo e(session('user')['id_dosen']); ?>";
...
<?php echo $__env->make('dosen.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\TUGAS KULIAH\PBF\Front _Sistem_Pengelolaan_Nilai_Mahasiswa\resources\views/dosen/nilai.blade.php ENDPATH**/ ?>