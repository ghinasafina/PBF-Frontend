...
<div style="width: 100%; min-height: 90vh;display: flex; justify-content: center; align-items; margin-top:4rem;">
  ...
  <div class="mb-3">
    ...
    <input type="password" class="form-control" id="id_matkul" aria-describedby="emailHelp">
  </div>
...
</html><?php /**PATH C:\TUGAS KULIAH\PBF\Front _Sistem_Pengelolaan_Nilai_Mahasiswa\resources\views/form-dosen.blade.php ENDPATH**/ ?>