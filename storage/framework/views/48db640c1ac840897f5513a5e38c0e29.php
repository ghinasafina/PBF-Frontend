...
<div class="d-flex justify-content-center mx-5">
    <table class="table border">
        ...
        <tbody>
            <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $matkul): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <tr>
                ...
                <td>
                    ...
                    data-id="<?php echo e($matkul['id_matkul']); ?>"
                    data-nama="<?php echo e($matkul['nama_matkul']); ?>"
                    data-sks="<?php echo e($matkul['sks']); ?>"
                    data-semester="<?php echo e($matkul['semester']); ?>">
                    Edit
                </button>
                <form action="<?php echo e(route('dosen.matkul.destroy', $matkul['id_matkul'])); ?>" method="POST" onsubmit="return confirm('Yakin ingin menghapus matkul ini?')">
                    <?php echo csrf_field(); ?>
...
<div class="modal fade" id="inputMatkulModal" tabindex="-1" aria-labelledby="inputMatkulModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <form action="<?php echo e(route('dosen.matkul.store')); ?>" method="POST">
                <?php echo csrf_field(); ?>
                ...
                <div class="modal-body row g-2 px-4">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="hidden" name="id_dosen" value="<?php echo e(session('user')['id_dosen']); ?>">
                        <input type="text" class="form-control" value="<?php echo e(session('user')['nama_dosen']); ?>" readonly>
                    </div>
                    <div class="col-md-6">
        ...
        <form id="formEditMatkul" method="POST">
          ...
          <div class="modal-body row g-2 px-4">
            ...
            <div class="col-md-6">
                ...
                <input type="text" id="edit_dosen" class="form-control" value="<?php echo e(session('user')['nama_dosen']); ?>" readonly>
            </div>  
            <div class="col-md-6">
...
<?php echo $__env->make('dosen.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\TUGAS KULIAH\PBF\Front _Sistem_Pengelolaan_Nilai_Mahasiswa\resources\views/dosen/matkul.blade.php ENDPATH**/ ?>