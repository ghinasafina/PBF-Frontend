  ...
  <div class="row m-5">
        <div class="col-md-4">
            <div class="card bg-primary text-white">
              <a href="/form-nilai" style="text-decoration: none;">
                <div class="card-body">
                  <h5 style="color: white; text-decoration: none;">Mahasiswa</h5>
                  <h2 style="color: white; text-decoration: none;"><?php echo e($jumlahMahasiswa); ?></h2>
                </div>
              </a>
            </div>
        </div>
        ...
        <div class="col-md-4">
            <div class="card bg-success text-white">
              <a href="/form-dosen" style="text-decoration: none;">
                <div class="card-body">
                    <h5 style="color: white; text-decoration: none;">Dosen</h5>
                    <h2 style="color: white; text-decoration: none;"><?php echo e($jumlahDosen); ?></h2>
                </div>
              </a>
            </div>
        </div>
        ...
        <div class="col-md-4">
            <div class="card bg-warning text-white">
              <a href="/mata-kuliah" style="text-decoration: none;">
                <div class="card-body">
                    <h5 style="color: white; text-decoration: none;">Mata Kuliah</h5>
                    <h2 style="color: white; text-decoration: none;"><?php echo e($jumlahMataKuliah); ?></h2>
                </div>
              </a>
            </div>
        </div>
...
</html><?php /**PATH C:\laragon\www\Sistem_Pengelolaan_Nilai_Mahasiswa\resources\views/dashboard.blade.php ENDPATH**/ ?>